...
router.get("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _b = (_a = console).log;
                return [4 /*yield*/, helloBlockchainFunction.showAll()];
            case 1:
                _b.apply(_a, [_c.sent()]);
...
router.post('/add', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, helloBlockchainFunction.verifyWord(req.body.message)];
            case 1:
                isValid = _a.sent();
                if (!isValid) {
                    helloBlockchainFunction.addWord(req.body.message);
                    res.send("".concat(req.body.message, " registrado!"));
                }
                else {
                    res.send("".concat(req.body.message, " j\u00E1 existe!"));
                }
                return [2 /*return*/];
        }
    });
